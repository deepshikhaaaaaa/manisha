                ...
                <div className=" sm:gap-[20px] gap-[8px]  flex flex-col">
                    <div className="flex sm:gap-[20px]  gap-[8px]">
                        <div className="flex flex-col sm:gap-[20px]  gap-[8px]">
                            <Image src="/gallery/Untitled (1).png" width={388} height={582} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(0);
                            }}></Image>
                            <Image src='/gallery/20200202_155726_3a9a17a4-25d5-4129-a08c-df6ec1ee8b61.png' width={388} height={478} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(1)
                            }}></Image>
                            <Image src='/gallery/20170419_231411_IMG_5480 1.png' width={388} height={418} alt="manisha" onClick={() => {
                                setlight(true);
                        ...
                        <div className="flex flex-col sm:gap-[20px]  gap-[8px]">
                            <Image src='/gallery/1 (8).png' width={793} height={467} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(3);
                            }}></Image>
                            <Image src='/gallery/20200202_155727_0ef71398-02bb-49a4-a964-bd774028c505.png' width={793} height={500} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(4)
                            }}></Image>
                            <div className="flex sm:gap-[20px]  gap-[8px] ">
                                <Image src='/gallery/20200202_155727_9bffcc1e-cdef-4f3b-b7d7-d2ec72be2296.png' width={388} height={509} alt="manisha" className="sm:w-[388px] sm:h-[509px] w-[150px] h-[150px]" onClick={() => {
                                    setlight(true);
                                    
                                    setindex(5)
                                }}></Image>
                                <Image src='/gallery/20180129_100617_IMG_0292 1.png' width={388} height={509} alt="manisha" className="sm:w-[388px] sm:h-[509px] w-[150px] h-[150px]" onClick={() => {
                                    setlight(true);
                    ...
                    <div className="sm:flex-row flex-col flex sm:gap-[20px]  gap-[8px]">
                        <Image src='/gallery/20200415_122907 1.png' width={796} height={665} alt="manisha" onClick={() => {
                            setlight(true);
                            
                            setindex(7)
                        }}></Image>
                        <Image src="/gallery/20200202_145352_3143716a-d19e-4930-88e5-212fa3378388 1.png" width={385} height={665} alt="manisha" onClick={() => {
                            setlight(true);
                    ...
                    <div className="flex sm:gap-[20px]  gap-[8px]">
                        <div className="flex flex-col sm:gap-[20px]  gap-[8px]">
                            <Image src="/gallery/IMG-20200907-WA0028 1.png" width={643} height={917} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(9)
                            }}></Image>
                            <Image src="/gallery/20180127_142733_fbedaa8b-1e8d-44ed-a5d1-0edaa1242757 1.png" width={643} height={804} alt="manisha" onClick={() => {
                                setlight(true);
                        ...
                        <div className="flex flex-col sm:gap-[20px]  gap-[8px]">
                            <Image src="/gallery/20180110_211638__ANK9452-22 1.png" width={531} height={782} alt="manisha" onClick={() => {
                                setlight(true);
                                
                                setindex(11)
                            }}></Image>
                            <Image src="/gallery/20130724_102948_IMG_8115 1.png" width={531} height={941} alt="manisha" onClick={() => {
                                setlight(true);
                    ...
                    <div className="flex flex-col sm:gap-[20px]  gap-[8px]">
                        <div className="flex sm:flex-row flex-col sm:gap-[20px]  gap-[8px] ">
                            <Image src="/gallery/20190410_172522_IMG_7229 1.png" width={747} height={677} alt="manisha" onClick={() => {
                                setlight(true);
                            ...
                            <Image src="/gallery/20190410_174321_IMG_7237.png" width={425} height={677} alt="manisha" onClick={() => {
                                setlight(true);
                        ...
                        <div className=" flex sm:flex-row flex-col gap-[20px]">
                            ...
                            <Image src="/gallery/20130126_011224_IMG_0015 1.png" width={408} height={544} alt="manisha" onClick={() => {
                                setlight(true);
                            ...
                            <Image src="/gallery/20180707_110625_IMG_6108.png" width={775} height={544} alt="manisha" onClick={() => {
                                setlight(true);
                    ...
                    <Image src="/gallery/_17I0991.png" width={1201} height={613} alt="manisha" onClick={() => {
                        setlight(true);
