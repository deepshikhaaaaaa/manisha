    ...
    return (
        <div className="h-[96px] w-full flex justify-between items-center md:px-[128px] sm:px-[60px] px-[20px]">
            ...
            <div className="font-montserrat font-medium text-[#202020] sm:text-[12px] text-[9px] uppercase flex md:gap-[40px] sm:gap-[20px] gap-[10px]">
                ...
                <Link href='' className="focus:underline hover:bg-black hover:text-white focus:bg-black focus:text-white px-2 py-1  hover:shadow-md hover:shadow-gray-500 transform hover:scale-110 transition ease-out delay-75">Gallery</Link>
